...
const offerSchema = new mongoose.Schema(
  {
    ...
    sourceRetailerFormat: { type: String, default: '', index: true },
    retailerFormats: { type: [String], default: [] },
    ...
    offerType: {
      type: String,
      enum: ['product', 'category-promotion', 'percent-promotion'],
      default: 'product',
      index: true,
    },
    ...
    discountUpToPercent: { type: Number, default: null, index: true },
    promotionScope: { type: String, default: '', index: true },
    appliesToCategory: { type: String, default: '', index: true },
    regionScope: { type: String, default: '', index: true },
