...
const compactSourceSummarySchema = new mongoose.Schema(
  {
    ...
    rejectedByReason: { type: mongoose.Schema.Types.Mixed, default: {} },
    rejectionReasons: [
      {
    ...
    missingImageCount: { type: Number, default: null },
    withImageCount: { type: Number, default: null },
    missingQuantityCount: { type: Number, default: 0 },
    unclearProductCount: { type: Number, default: 0 },
    upcomingCount: { type: Number, default: 0 },
    expiredCount: { type: Number, default: 0 },
    parseFailedCount: { type: Number, default: 0 },
    categoryUnclearCount: { type: Number, default: 0 },
    storedRatio: { type: Number, default: null },
    imageCoverageRatio: { type: Number, default: null },
    freshnessStatus: { type: String, default: 'unknown' },
...
const perRetailerSchema = new mongoose.Schema(
  {
    ...
    skippedSources: { type: Number, default: 0 },
    policyBoundedSources: { type: Number, default: 0 },
    foundRawItems: { type: Number, default: 0 },
    parsedOffers: { type: Number, default: 0 },
    offersStored: { type: Number, default: 0 },
    rejectedOffers: { type: Number, default: 0 },
